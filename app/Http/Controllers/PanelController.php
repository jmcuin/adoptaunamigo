...
class PanelController extends Controller
{
    ...
    public function index()
    {
        ...
        $amigos_en_adopcion = Amigo::where('solicita_adopcion', true)->get();
        $amigos_adoptados = Amigo::where('solicita_adopcion', false)->get();
        $amigos_esterilizacion = Amigo::where('solicita_esterilizacion', false)->get();
        $amigos_hogar_temporal = Amigo::where('solicita_hogar_temporal', false)->get();
        $amigos_ayuda_medica = Amigo::where('solicita_ayuda_medica', false)->get();
        $amigos_ayuda_alimenticia = Amigo::where('solicita_ayuda_alimenticia', false)->get();

        return view('Panel.index', compact('rescatistas', 'amigos_en_adopcion', 'amigos_adoptados', 'amigos_esterilizacion', 'amigos_hogar_temporal', 'amigos_ayuda_medica', 'amigos_ayuda_alimenticia'));
