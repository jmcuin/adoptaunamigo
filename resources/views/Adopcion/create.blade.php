...
@section('contenido')
<form method="POST" id="registrar_amigo" enctype="multipart/form-data" action="{{ route('Adopcion.store') }}">
	{!! csrf_field() !!}
	<input type="text" name="id_amigo" value="{{ $amigo -> id_amigo }}" hidden="hidden">
	<input type="text" name="id_solicitud" value="{{ $solicitud -> id_solicitud }}" hidden="hidden">
				...
				<div class="row">
					<div class="col-sm-4 form-group"> 
						<label for="nombre_adoptante">
							...
							<input type="text" name="nombre_adoptante" value="{{ $solicitud -> nombre_solicitante }}" class="form-control" placeholder="Nombre(s) del amigo">
					...
					<div class="col-sm-4 form-group"> 
						<label for="email">
							...
							<input type="email" name="email" id="email" value="{{ $solicitud -> email }}" class="form-control" placeholder="mail@mail.com">
							{{ $errors -> first('email') }}
						</label>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-4 form-group">
						<label for="telefono">
							...
							<input type="text" name="telefono" value="{{ $solicitud -> telefono }}" class="form-control" placeholder="Teléfono del adoptante...">
