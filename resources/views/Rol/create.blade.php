		...
		<div class="col-lg-12 well">
			<div class="col-sm-12">
				<div class="row" align="center">
					<label for="rol_key">
					Palabra Clave 
						<input type="text" name="rol_key" value="{{old('rol_key')}}" class="form-control" placeholder="Rescatista, etc...">
						{{ $errors -> first('rol_key') }}
					</label>
					<label for="rol">
					Rol
						<input type="text" name="rol" value="{{old('rol')}}" class="form-control" placeholder="rescatista, etc...">
						{{ $errors -> first('rol') }}
					</label>
				</div>
				<div class="row" align="center">
					...
					Descripción de sus Funciones 
						<input type="text" name="descripcion" value="{{old('descripcion')}}" class="form-control" placeholder="Rescatista en la zona oriente...">
